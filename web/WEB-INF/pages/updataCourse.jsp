...
<div class="container" style="margin-top: 20px;">
    ...
    <form id="infoForm" class="form-horizontal" action="CourseController/updata.do" method="post"
          novalidate="novalidate">

        <div class="form-group">
            <label for="courseId" class="col-sm-2 control-label">ID</label>
            <div class="col-sm-10">
                <input type="text" readonly="true" name="courseId" id="courseId" placeholder="主讲人Id自动生成"
