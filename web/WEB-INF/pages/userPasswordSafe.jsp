            ...
            <div class="proflle_tab_body">
                <div class="proflle_tab_workplace clearfix">
                    ...
                    <div class="profile_ifo_area">
                        <form action="UserController/userUpdate.do" method="post">
                            <div class="form_group">
                                <span class="dd">旧　密　码：</span>
                                <input id="pass" name="pass" type="password"><span id="oldMsg"></span>
                            </div>
                            <div class="form_group">
                                <span class="dd">新　密　码：</span>
                                <input id="pass1" name="userPassword" type="password">
                            </div>
                            <div class="form_group">
                                <span class="dd">确认新密码：</span>
                                <input id="pass2" name="userPassword" type="password"><span id="passMsg"></span>
                            </div>
...
<footer>
    <div class="container">
        <ul>
            <li><img src="./密码安全_files/footer_logo.png" alt="" id="foot_logo"></li>
            <li>版权所有：智游3G教育　　　©&nbsp;www.zhiyou100.com</li>
            <li><img src="./密码安全_files/a.png" alt="" id="wxgzh"></li>
        </ul>
    </div>
</footer>
