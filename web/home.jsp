...
<head>
    ...
    <script type="text/javascript" src="z/gVerify.js"></script>
    ...
    <div class="container">
        ...
        <div class="course-info">
            <table cellspacing="10">
                <tbody>
                <tr>
                    <td colspan="2"><a href="AdminController/videoShow.do?id=6">
                    ...
                    <td>
                        <!--上线时修改id--> <a href="AdminController/videoShow.do?id=9">
                        <img src="z/ui.jpg"
                             alt=""
                             class="image scale"
                             draggable="false">
                    ...
                    <td rowspan="2" class="one_three"><a href="AdminController/videoShow.do?id=" class="opacity5">
                ...
                <tr>
                    <td><a href="AdminController/videoShow.do?id=" class="opacity5">
                        <img src="z/bigdata.jpg" alt="" class="image" draggable="false">
                        <div class="headline">
                            <span>大数据教程</span> <img src="z/arrow.png" alt="">
                        </div>
                    </a></td>
                    <td colspan="2"><a href="AdminController/videoShow.do?id=11">
                ...
                <tr>
                    <td colspan="2"><a href="AdminController/videoShow.do?id=13">
                        <img src="z/php.jpg" alt="" class="image scale" draggable="false">
                        <div class="headline">
                            <span>PHP教程</span> <img src="z/arrow.png" alt="">
                        </div>
                    </a></td>
                    <td colspan="2" class="three_two"><a href="AdminController/videoShow.do?id="><img src="z/qidai.jpg" alt="" class="image" draggable="false">
                        <div class="headline">更多课程，敬请期待...</div></a>
                    </td>
                </tr>
                </tbody>
            </table>
...
<div class="form_area">
    <div class="container">
        ...
        <form id="iform" action="http://localhost:8080/090/plus/dmail.php" enctype="multipart/form-data" method="post">
            ...
            <div class="wrap">
                <input name="action" value="post" type="hidden"> <input name="diyid" value="3" type="hidden">
                <input name="do" value="2" type="hidden"> <input name="ip" value="" type="hidden">
    ...
    <div class="mask_content">
        ...
        <div class="mask_content_body">
            <form id="loginForm" action="">
                <h3>快速登录</h3>
                <input id="loginEmail" placeholder="请输入邮箱" name="userEmail" type="email">
                <input id="loginPassword" placeholder="请输入密码" name="userPassword" type="password">
                <div id="forget">
                    <a href="UserController/forgetPassword.do">忘记密码？</a>
                </div>
    ...
    <div class="mask_content">
        ...
        <div class="mask_content_body">
            <form id="regForm" action="#">
                <h3>新用户注册</h3>
                <input id="regEmail" placeholder="请输入邮箱" name="userEmail" type="email"><span id="emailMsg"></span>
                <input id="regPsw" placeholder="请输入密码" name="userPassword" type="password">
                <input id="regPswAgain" placeholder="请再次输入密码" name="psw_again" type="password"><span
                    id="passMsg"></span>
...
<script src="z/jquery-1.js" type="text/javascript"></script>
<script src="z/gVerify.js" type="text/javascript"></script>
<script src="z/index.js" type="text/javascript"></script>
